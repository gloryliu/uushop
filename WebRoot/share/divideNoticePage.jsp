...
<%@ taglib uri="/struts-tags" prefix="s" %>
 ...
 <s:else><a href="showNotice.do?currentPage=<s:property value="pageBean.currentPage-1"/>">上一页</a></s:else>
 <s:if test="0>pageBean.pageCount-7">
 	<s:iterator var="n" begin="1" end="pageBean.pageCount" >
 		<a href="showNotice.do?currentPage=<s:property value="#n-1"/>"><s:property /></a>
 	</s:iterator>
	</s:if>
 <s:else>
 ...
 <s:else><a href="showNotice.do?currentPage=<s:property value="pageBean.currentPage+1"/>">下一页</a></s:else>
