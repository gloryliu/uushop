...
<form action="${pageContext.request.contextPath}/book_addBook.do" enctype="multipart/form-data" id="addBookForm" method="post">
    <div class="form">
    <p class="form_box_p margin_right1">
        <span class="req">最多50个字</span>
        <label>商品名称<span>(必填)</span></label>
        <input name="bname" id="bname" type="text" class="field size4" />
        <span class="clear"></span>
    </p>	
    <p class="form_box_p">
        <span class="req">单位为元</span>
        <label>商品价格<span>(必填)</span></label>
        <input name="price" id="price" type="text" class="field size4" />
        <span class="clear"></span>
    </p>
    <p class="form_box_p margin_right1">
        <span class="req"></span>
        <label>图书作者<span>(必填)</span></label>
        <input name="author" id="author" type="text" class="field size4" />
        <span class="clear"></span>
    </p>
    <p class="form_box_p">
        <span class="req"></span>
        <label>出版商<span>(必填)</span></label>
        <input name="publishCompany" id="publishCompany" type="text" class="field size4" />
        <span class="clear"></span>
    </p>	
    <p class="form_box_p margin_right1">
        <span class="req">格式为：2012/3/23</span>
        <label>出版日期<span>(必填)</span></label>
        <input name="publishDate" id="publishDate" type="text" class="field size4" />
        <span class="clear"></span>
    </p>	
    <p class="form_box_p">
    ...
    <p class="inline-field" >
       ...
       <input type="text" name="btype" id="bType" class="field size3" style="text-align:left;"/>
       <input type="text" name="stype" id="sType" class="field size3" />
        <span class="clear"></span>
    </p>   
    <p>
        <span class="req"></span>
        <label>商品描述<span>(非必填)</span></label>
        <textarea name="bookInfo" id="bookInfo"  style="width:820px;min-height:300px;"></textarea>
    </p>	 				    
    </div>
    <div class="buttons">
