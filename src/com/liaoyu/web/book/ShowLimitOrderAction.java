...
@Controller
public class ShowLimitOrderAction  extends ActionSupport implements ModelDriven<PageBean>{
	...
	public String execute(){
		...
		QueryResult<Order> qr=os.getScrollData(pageBean.getCurrentPage()*pageBean.getPageSize(), pageBean.getPageSize());
